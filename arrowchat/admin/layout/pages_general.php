					...
					?>
						<dl class="selectionBox">
							...
							<dd>
								...
								<p class="explain">
									If you would like your users to be able to connect to Facebook and chat with their Facebook friends enter your Facebook app ID here.  <a target="_blank" href="http://www.nullrefer.com/?http://www.arrowchat.com/documentation/?p=facebook-integration">Click here for instructions on how to get and setup your Facebook app</a>.  Leave this BLANK if you do not want to use Facebook integration.
								</p>
							</dd>
						</dl>
					<?php
