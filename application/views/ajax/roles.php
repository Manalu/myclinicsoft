		        ...
		        "aoColumnDefs": [
		            ...
		            },
		            {
		                ...
		                "render": function (data, type, row) {
		                    ...
		                    newData = '<a rel="tooltip" data-placement="bottom" data-original-title="Details" href="'+BASE_URL+'roles/details/'+row['role_id']+'" class="bootbox link">'+row['role_name']+'</a>';
		                    return newData;
		            ...
		            },
		           {
		                ...
		                "render": function (data, type, row) {
		                    ...
		                    if(row['role_name'] != 'Admin'){
								if(can_delete){
									newData = '<a rel="tooltip" data-placement="bottom" data-original-title="Delete" href="'+BASE_URL+'roles/delete/'+row['role_id']+'" class="delete btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></a>&nbsp;';
								}
								if(can_update){
									newData += '<a rel="tooltip" data-placement="bottom" data-original-title="Update"  href="'+BASE_URL+'roles/view/'+row['role_id']+'/" class="bootbox btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>';
								}
							}else{
