<?php if(count($result) > 0) { ?>
	<table class="table">
		<thead>
			<tr>
				<th colspan="3"><p><?php echo ucfirst($type);?></p></th>
				<th>
		...
		<tbody>
			...
			<?php foreach($result as $row) { ?>
				...
				<tr id="row-<?php echo $row['id'];?>">
					<td>
						<img class="img-responsive" style="width:30px; height:30px" src="<?php echo base_url('/uploads/'.$this->license_id.'/'.$row['file_name']);?>" alt="">
					</td>
					<td>
