		...
		<tbody>
			...
			<?php foreach($result as $row) { ?>
				<tr id="row-<?php echo $row['id'];?>">
					<td>
						<strong id="history-<?php echo $row['id'];?>"><?php echo $row['test'] .' / ' .$row['specimen'];?></strong></br>
						<strong id="history-<?php echo $row['id'];?>"><?php echo $row['conventional_units'] .' / ' .$row['si_units'];?></strong></br>
