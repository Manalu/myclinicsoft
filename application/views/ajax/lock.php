<form class="lockscreen animated flipInY" action="">
	<div class="logo">
		<h1 class="semi-bold"><img src="<?php echo base_url(); ?>img/logo-o.png" alt="" /> SmartAdmin</h1>
	</div>
	<div>
		<img src="<?php echo base_url(); ?>img/avatars/sunny-big.png" alt="" width="120" height="120" />
		<div>
