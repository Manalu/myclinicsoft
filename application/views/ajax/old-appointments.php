		        ...
		        "aoColumnDefs": [
		            ...
		            },
		            {
		                ...
		                "render": function (data, type, row) {
		                    ...
		                    newData = '<a rel="tooltip" data-placement="bottom" data-original-title="<?php echo $this->lang->line('__common_details');?>" href="'+BASE_URL+'appointments/details/'+row['id']+'" class="bootbox link">'+row['schedule_date']+'</a>';
		                    return newData;
		            ...
		            },
		            {
		                ...
		                "render": function (data, type, row) {
							...
							if(isAdmin){
								newData = '<?php echo $this->lang->line('__patient');?> : <strong>'+ row['patient_name']+'</strong>';
							}else{
								newData = '<?php echo $this->lang->line('__doctor');?> : <strong>'+ row['doctor_fullname']+'</strong>';
							}
		                    return newData;
		            ...
		            },
		            {
		                ...
		                "render": function (data, type, row) {
							...
							if(row['status'] == 'Cancel'){
								s = '<span class="label label-danger"><?php echo $this->lang->line('__common_cancel');?></span>';
							}else if(row['status'] == 'Pending'){
								s = '<span class="label label-warning"><?php echo $this->lang->line('__common_pending');?></span>';
							}else{
								s = '<span class="label label-success"><?php echo $this->lang->line('__common_approve');?></span>';
							}
...

		           {
		                ...
		                "render": function (data, type, row) {
		                   ...
		                   if(row['status'] != 'Approve'){
							if(can_delete){
								newData = '<a rel="tooltip" data-placement="bottom" data-original-title="<?php echo $this->lang->line('__common_delete');?>" href="'+BASE_URL+'appointments/delete/'+row['id']+'" class="delete btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></a>&nbsp;';
							}
							if(can_update){
								newData += '<a rel="tooltip" data-placement="bottom" data-original-title="<?php echo $this->lang->line('__common_update');?>"  href="'+BASE_URL+'appointments/view/'+row['id']+'/" class="bootbox btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>';
							}
							}
							return newData;
		                },
